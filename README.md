...
| the share theory motivates | 164 of 4,438 spectra (**3.7%**), over 76 (final state, mass) pairs; the category has to be one the models produce, not just the mass observable | `scan_summary.csv`, per composition in `priority_scan.csv` |
