...
from ..stats.fdr import accepted, smallest_uniforms as _smallest_uniforms
from ..viz.style import (C_ARG as c_bar, C_BKG as c_bh, C_THR as c_thr, INK as ink,
...
@stage(
    name="bh-zcut",
    group="stats",
    summary="the significance the BH cut actually lands on, per pseudo-experiment",
    outputs=["plots/max_of_gaussians/bh_zcut.png", "tables/bh_zcut_per_pe.csv"],
)
def main(options=None):
    ...
    out = io.ensure(paths.table("bh_zcut_per_pe.csv"))
    ...
    io.save(fig, paths.gaussians("bh_zcut.png"), dpi=400, facecolor=surf, bbox_inches="tight")
