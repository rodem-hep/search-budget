...
A single background-only sweep of the 63-spectrum budget expects `N x p(>=3 sigma)` = 4319 x 1.35e-3 = **5.8** reports (**9.8** at selection granularity, N = 7231). The observed 6 sits between the two.
