...
| mass resolution, per channel (&dagger;) | each r independently, x2 per sigma (16-84%) | +0.02/-0.02 | +0.00/+0.00 | +0.02/-0.02 |
...
| scan windows | every edge x1.4 either way (published), x1.25 (generic) | +0.03/-0.04 | +0.02/-0.02 | +0.02/-0.01 |
...
|---|---|--:|--:|
| counting granularity | published event selections instead of inclusive spectra | 6.54 | - |
