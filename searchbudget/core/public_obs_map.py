...
PUBLIC_OBS = {
    ...
    "Singlet scalar / SM+Scalars":   ["m(HH)", "m(VV)", "m(Vgamma)", "m(gammagamma)"],
    "Higgs portal":                  ["m(HH)"],
    "TRSM (singlet/triplet)":        ["m(HH)", "m(VV)", "m(bb)"],
    "HeavyHiggs THDM":               ["m(tt)", "m(VV)"],
    "Vector-like quark (VLQ)":       ["m(ttZ)/m(Zt)", "m(tb)", "m(Wb)", "m(Ht)", "m(bZ)", "m(tW)",
                                      "m(jV)", "m(jH)"],
    "Vector-like lepton (VLL)":      ["multilepton", "m(eZ)", "m(muZ)", "m(tauV)",
                                      "m(eH)", "m(muH)"],
    ...
    "MSSM/NMSSM/RPV SUSY":           ["m(tautau)", "m(bb)", "m(3j)", "m(HH)"],
    ...
    "Color-octet scalar (MW)":       ["m(bb)", "m(jj)"],
    ...
    "RPV resonant slepton":          ["m(mujj)", "m(mumujj)", "m(emu) LFV", "m(etau) LFV",
                                      "m(mutau) LFV"],
    "Zee-Babu":                      ["m(ee) SS", "m(emu) SS", "m(mumu) SS"],
    "Bilepton (331)":                ["m(ee) SS", "m(emu) SS", "m(mumu) SS"],
    "String / Regge resonance":      ["m(jj)", "m(jgamma)"],
}
...
LITERATURE = {
    ...
    "Bilepton (331)":                ("1806.04536", "1812.02723"),
    "String / Regge resonance":      ("0808.0497", "0804.2013"),
}
...
WIDTH = {
    ...
    "Bilepton (331)":                ("benchmark", "vector Y++ a few % at gauge coupling; the scalar bilepton narrower"),
    "String / Regge resonance":      ("benchmark", "first Regge excitations, a few % to ~10% against r=0.05 on m(jj)"),
...
NSEL = {
    ...
    "m(jV)":         (1, "jet + boosted W/Z (no ATLAS search)"),
    "m(jH)":         (1, "jet + boosted h (no search at any collider)"),
    "m(eH)":         (1, "electron + h (no ATLAS search)"),
    "m(muH)":        (1, "muon + h (no ATLAS search)"),
    "m(tauV)":       (1, "hadronic-tau + W/Z (no ATLAS search)"),
    "m(et)":         (1, "electron + top (no ATLAS search)"),
    "m(mut)":        (1, "muon + top (no ATLAS search)"),
}
NSEL_DEFAULT = 2
